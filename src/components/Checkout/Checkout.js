...
fetch('/.netlify/functions/createOrder', {
        ...
        body: JSON.stringify({ productLists: cartItems, orderId:orderId, total: total, userDetails:{
          name: user.name,
          phone: user.phone,
          email: user.email,
        ...
        .then(data => {
          ...
          setLoading(false);
          setToast(true);
      const message =  `This is to notify that I have placed an order. Order #${orderId}`;
